...
# Wan currently exposes sequence parallelism for this path. This script is the
# requested "tp4" hardware-control baseline, implemented with SP_SIZE=4.
export SP_SIZE=4
...
torchrun \
  ...
  --nproc_per_node=4 \
  pipe_forcing/wan_dmd_baselines.py \
  --mode append \
  --sp_size 4 \
